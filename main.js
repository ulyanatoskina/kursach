//  HTTP_PORT=3001 P2P_PORT=6001 npm start ?команда для первого терминала
//  HTTP_PORT=3002 P2P_PORT=6002 PEERS=ws://localhost:6001 npm start ?для второго терминала
//  http://localhost:3001/blocks ?локалхост
'use strict';
...
var calculateHash = (index, previousHash, timestamp, data, nonce) => {
    ...
    for (var i = 0; i < hash.length; i++) {
        hexHash += parseInt(hash[i], 16).toString(12);
    }
    return hexHash;
};
